...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_spotlight_contents_submission_id'), 'spotlight_contents', ['submission_id'], unique=True)
    op.create_index(op.f('ix_spotlight_contents_spotlight_id'), 'spotlight_contents', ['spotlight_id'], unique=False)
